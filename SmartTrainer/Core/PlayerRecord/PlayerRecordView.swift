...
struct PlayerRecordView: View {
    ...
    private var techniques: [Technique] = [
        ...
        Technique(id: UUID().uuidString, techniqueName: "Pull Up", videoURL: "123", description: "Hang from the pull-up bar, grip shoulder-width apart, and pull your body up until your chin clears the bar. Lower down with control. ", aiModel: "123fsdrf", thumbnail: "pull_up")
    ]
