...
struct AIScoresChartView: View {
    var rangeData: ChartPoint = .init(title: "Range", value: 3.1)
    var controlData: ChartPoint = .init(title: "Control", value: 4.5)
    var formData: ChartPoint = .init(title: "Form", value: 3.2)
    var body: some View {
        Chart {
